...
import DonationItemsModal from '@/modules/inventaris/admin/components/dashboard/inventaris/DonationItemsModal';
import RiwayatTransaksiInventaris from '@/modules/inventaris/admin/components/dashboard/inventaris/RiwayatTransaksiInventaris';
import InventorySummaryCards from '@/modules/inventaris/admin/components/dashboard/inventaris/InventorySummaryCards';
import InventoryChartsSection from '@/modules/inventaris/admin/components/dashboard/inventaris/InventoryChartsSection';
import {
  getInventoryDashboardStats,
  getInventoryMonthlyData,
  getInventoryConditionData,
  getPendingDonations
} from '@/modules/inventaris/services/inventarisDashboard.service';
import type {
  InventoryStats,
...
import { getLowStock, getNearExpiry, listTransactions } from '@/modules/inventaris/services/inventaris.service';
